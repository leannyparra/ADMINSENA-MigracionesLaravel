...
<div class="container my-5">
    ...
    <div class="bg-white border rounded-3 shadow-sm overflow-hidden" style="max-width: 750px;">
        ...
        <div class="bg-light border-top p-4 d-flex justify-content-end gap-3">
            ...
            <!-- Enlace de edición en singular para course -->
            <a href="{{ url('/course/' . $course->id . '/edit') }}" class="btn text-white fw-semibold px-4 py-2 shadow-sm custom-btn-continue" style="background-color: #39A900; font-size: 0.85rem; letter-spacing: 0.5px;">
                EDITAR FICHA <i class="bi bi-arrow-right ms-1"></i>
            </a>
        </div>
