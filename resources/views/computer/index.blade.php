...
<div class="container my-5">
    ...
    <div class="bg-white border rounded-3 shadow-sm overflow-hidden">
        ...
        <div class="p-4 bg-light border-bottom d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
            ...
            <!-- Buscador -->
            <form action="{{ url('computer/list') }}" method="GET" class="d-flex align-items-center position-relative" style="max-width: 320px; width: 100%;">
        ...
        <!-- Tabla de Computadores (Campos de Migración Reales) -->
            ...
            <table class="table table-hover align-middle m-0 style-flat-table">
                <thead class="table-light text-secondary uppercase small fw-semibold border-bottom">
                    <tr>
                        ...
                        <th class="px-4 py-3" style="width: 180px;">Número de Equipo</th>
                ...
                <tbody class="text-dark">
                    @forelse($computers as $computer)
                        <tr>
                            ...
                            <td class="px-4 py-3 fw-medium text-secondary">#{{ $computer->id }}</td>
                            
                            <!-- Número del Computador (number) -->
                            ...
                            <!-- Marca (brand) -->
                            <td class="px-4 py-3 text-secondary fw-medium">
                                {{ $computer->brand }}
                            </td>
                        ...
                        <form action="{{ route('computer.destroy', $computer->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('delete')
                            <button type="submit" class="btn-delete-custom" title="Eliminar Aprendiz" onclick="return confirm('¿Estás seguro de que deseas eliminar este equipo?')">
