...
//main
Route::get('/', [MainController::class, 'index'])->name('nosotros');

Route::get('/nosotros', function () {return view('main');})->name('main');
...
// Rutas para CourseTeacher--PIVOTE (migrado a API, ver routes/api.php)
